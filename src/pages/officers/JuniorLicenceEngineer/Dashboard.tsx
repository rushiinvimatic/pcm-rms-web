...
export const JuniorLicenceEngineerDashboard: React.FC = () => {
  ...
  const fetchPendingApplications = async () => {
    await callApi(async () => {
      try {
        // Fetch applications that are pending for Junior Licence Engineer review
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Engineering Review Dashboard</h1>
            <p className="mt-1 text-sm text-gray-600">Review applications and verify technical documentation</p>
          </div>
          <Button
...
export default JuniorLicenceEngineerDashboard;